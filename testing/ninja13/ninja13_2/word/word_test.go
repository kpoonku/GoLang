...
func TestGetWordCount(t *testing.T) {
	m := getWordCount("I am Dog and Dog like bone and bone is very hard. I like Dog")
	for k, v := range m {
		//Dog:3 I:2 am:1 and:2 bone:2 hard.:1 is:1 like:2 very:1
		switch k {
		case "Dog":
			if v != 3 {
				t.Error("Expected", 3, "actual", v)
			}
		case "I":
			if v != 2 {
